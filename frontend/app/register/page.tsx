...
export default function RegisterPage() {
      ...
      <div className="min-h-screen bg-emerald-50 dark:bg-emerald-950/40">
        ...
        <main className="mx-auto flex max-w-md flex-col items-center justify-center px-4 py-16">
          <div className="w-full rounded-xl border border-emerald-200/80 bg-white p-8 shadow-sm dark:border-emerald-800/60 dark:bg-emerald-950/40">
            <h1 className="text-xl font-semibold text-emerald-800 dark:text-emerald-100">Account created</h1>
  ...
  return (
    <div className="min-h-screen bg-emerald-50 dark:bg-emerald-950/40">
      ...
      <main className="mx-auto flex max-w-md flex-col items-center justify-center px-4 py-16">
        <div className="w-full rounded-xl border border-emerald-200/80 bg-white p-8 shadow-sm dark:border-emerald-800/60 dark:bg-emerald-950/40">
          <h1 className="text-xl font-semibold text-emerald-800 dark:text-emerald-100">Parent registration</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <Link href="/login" className="text-sm font-medium text-emerald-700 hover:underline dark:text-emerald-400">
                Sign in
              </Link>
