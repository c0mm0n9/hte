"""
LLM chat completions client for info_graph (MiniMax M2.5 by default; supports OpenAI-compatible APIs).
"""
...
async def chat_completions(
    ...
    *,
    ...
    Uses INFOGRAPH_LLM_BASE_URL + INFOGRAPH_LLM_PATH (e.g. MiniMax /text/chatcompletion_v2).
    """
    base = (settings.llm_base_url or "").rstrip("/")
    if not base:
        raise ValueError("INFOGRAPH_LLM_BASE_URL is not set")
